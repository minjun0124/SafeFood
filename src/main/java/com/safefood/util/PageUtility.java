...
public class PageUtility {
	...
	public String getPageBar() {
		...
		if (currentpagecount > firstpagecount)
			sb.append("<a href='javascript:pagelist(" + (currentpagecount-1) + ")' aria-label='Previous'>" + 
		...
		if (currentpagecount < lastpagecount)
			sb.append("<li><a href='javascript:pagelist(" + (currentpagecount+1) + ")' aria-label='Next'>" + 
					"        <span aria-hidden='true'>&raquo;</span>" + 
					"      </a> " + 
					"    </li> </ul> " + 
					"</nav>");
		else
			sb.append("<li><a href='#' aria-label='Next'>" + 
					"        <span aria-hidden='true'>&raquo;</span>" + 
					"      </a>" + 
					"    </li> </ul>" + 
					"</nav>");
	...
	public String getPageBar2() {
		...
		if (firstpagecount > pagePercount)
			sb.append(" <a href='javascript:pagelist(" + beforetenpage + ")'><img style='display:inline;' src=\""
					+ imagepath + "btn_first.gif\" border='0'  hspace='3' align='absmiddle'></a>&nbsp;&nbsp;");
		else
			sb.append("<img  style='display:inline;' src=\"" + imagepath
					+ "btn_first.gif\" border='0'  align=absmiddle>&nbsp;&nbsp;");

		if (((currentpagecount - 1) / pagePercount * pagePercount) + 1 > beforetenpage)
			sb.append("<a href='javascript:pagelist(" + beforetenpage + ")'><img  style='display:inline;' src=\""
					+ imagepath + "btn_prev.gif\" border='0' hspace='3' align=absmiddle></a>&nbsp;&nbsp;");
		else
			sb.append("<img   style='display:inline;' src=\"" + imagepath
					+ "btn_prev.gif\" border='0'   align=absmiddle>&nbsp;&nbsp;");
		...
		if (nexttenpage < ((totalpagecount - 1) / pagePercount + 1) * pagePercount)
			sb.append("&nbsp;&nbsp;<a href='javascript:pagelist(" + (nexttenpage)
					+ ")'><img style='display:inline;' src=\"" + imagepath
					+ "btn_next.gif\" border='0' hspace='3' align=absmiddle></a>");
		else
			sb.append("&nbsp;&nbsp;<img style='display:inline;' src=\"" + imagepath
					+ "btn_next.gif\" border='0' hspace='3' align=absmiddle>");
		...
		if ((((currentpagecount - 1) / pagePercount) + 1) * pagePercount < nexttenpage)
			...
			sb.append("&nbsp;&nbsp;<img style='display:inline;' src=\"" + imagepath
					+ "btn_end.gif\" border='0' align=absmiddle>");
