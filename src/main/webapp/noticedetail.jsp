...
<body>
			...
			<div class="container">
				<div class="row">
					...
					<div class="main col-12">
						...
						<!-- ================ -->
						<div align="center">
							<input type='hidden' v-model="id" v_bind:value="notice.id">
							<table class="table table-hover">
								...
								<tr style="height:300px;">
									...
									<td style="width:80%;">{{notice.contents}}</td>
								</tr>	
							</table>
							...
							<div align="center">
								<button   type="button" class="btn btn-primary" @click="noticeList">돌아가기</button>
								<button v-if="notice.id == id"  type="button" class="btn btn-warning" @click="noticeUpdate">수정하기</button>
								<button v-if="notice.id == id"  type="button" class="btn btn-danger" @click="noticeDelete">삭제하기</button>
	...
	<script type="text/javascript">
		var qnatable = new Vue({
			...
			, mounted : function(){
				axios.get('http://70.12.108.177:8197/SafeFoodBoot/api/detailQ/'+${param.no})
				...
				axios.get('http://70.12.108.177:8197/SafeFoodBoot/api/searchA/'+${param.no})
			...
			, methods : {
				...
				, answerDelete : function(){
					axios.delete('http://70.12.108.177:8197/SafeFoodBoot/api/deleteA/'+${param.no})
						.then( response => {
							if(response.data.state=='true'){
								alert('삭제 성공')
